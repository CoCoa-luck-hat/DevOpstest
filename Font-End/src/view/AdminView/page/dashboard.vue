...
<template>
    <div class="">
        <v-row>
            ...
            <v-col cols="6">
                <div class="box-col" style="padding: 20px; padding-bottom: 10px;">
                    ...
                    <div class="w-100 pa-2 pb-0 mt-1">
                        <v-data-iterator :items="UserStore.users" :page="pageUser" :items-per-page="3">
                            <template v-slot:default="{ items }">
                                <template v-for="user in items" :key="user.raw.id_user">
                                    <div class="d-flex" style="justify-content: space-between; align-items: center;">
                                        <div class="d-flex flex-column">
                                            <span style="font-size: 18px; font-weight: 600;">{{ user.raw.username
                                                }}</span>
                                            <p style="font-size: 14px;" class="text-grey">{{ user.raw.email }}</p>
                                        </div>
                                        <p class="text-grey">
                                            สร้างเมือ: {{ user.raw.Date_At }}
                                        </p>
                                    </div>
                                </template>
                            </template>
            ...
            <v-col cols="12">
                <div class="box-col" style="padding: 30px;">
                    ...
                    <div class="w-100 mt-5">
                        <v-data-iterator :items="Reports.reports" :page="pageReport" :items-per-page="4">
                            <template v-slot:default="{ items }">
                                <v-row>
